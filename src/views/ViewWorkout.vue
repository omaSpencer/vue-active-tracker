			...
			<div class="flex flex-col items-center p-8 rounded-md shadow-md bg-light-grey relative">
				<div v-if="user" class="absolute flex left-2 top-2 gap-x-2">
					<span
						...
						"
					>
						<img class="h-3.5 w-auto" src="@/assets/images/pencil-light.png" alt="edit icon" />
					</span>
					<span
						class="
							h-7
				...
				<img
					...
					alt="cardio img"
				/>
				<img v-else class="h-24 auto" src="@/assets/images/dumbbell-light-green.png" alt="strength img" />
